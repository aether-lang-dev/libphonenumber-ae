 ...
 *
 * This is test scaffolding, not part of the binding: `phonenumber_ae_native.so`
 * loads into any real Lua 5.4 host. `.tests.ae` skips this entirely when a
 * `lua5.4` binary is already available.
 *

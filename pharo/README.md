...
"-> an OrderedCollection: 'America/New_York'"
PhonenumberAe timeZonesForNumber: '2070313000' region: 'GB'.
...
- **Time zones**: `timeZonesForNumber:region:` (a non-empty OrderedCollection
